/**
 * Source Code By Angga Store
 * support Gw: https://whatsapp.com/channel/0029Val9aN996H4MmCpyzp1b
 * makasih,, jangan direname yah hargai yang membuat :)
 */
...
async function startEza() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Created: https://github.com/Agastore", "green"));
      console.log(color("Donate: ↘", "yellow"));
      console.log(color("Saweria: https://saweria.co/masaga", "yellow"));
